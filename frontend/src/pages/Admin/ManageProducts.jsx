    ...
    <div className="px-8 py-10 bg-neutral-50 min-h-screen w-full">
      <div className="flex justify-between items-center mb-8">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold px-5 py-2.5 rounded-lg shadow"
        >
          <PlusCircle size={20} />
          Add Product
        </button>
      ...
      {showForm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="bg-white w-full max-w-2xl rounded-2xl shadow-2xl relative p-8 overflow-y-auto max-h-[90vh]">
            <button
              onClick={() => {
                setShowForm(false);
                setEditing(null);
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium">Status Badge</label>
                <input
                  value={form.statusBadge}
                  onChange={(e) =>
                    setForm({ ...form, statusBadge: e.target.value })
